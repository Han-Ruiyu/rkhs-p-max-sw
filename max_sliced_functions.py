...
def max_swdistance_empirical(I0,I1,N, p, L=2000):
    '''
...
def expected_max_swdistance_empirical_embed_into_gaussian_rkhs(distribution,p,N, n_montecarlo,sigma=2,d_test=5):
    '''
